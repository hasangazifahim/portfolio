...
function initThemeToggle() {
  ...
  function updateIcon() {
    ...
    if (toggleBtn) {
      toggleBtn.setAttribute('aria-label', isDark ? 'Switch to light mode' : 'Toggle dark mode');
      toggleBtn.setAttribute('title', isDark ? 'Switch to light mode' : 'Toggle dark mode');
    }
  }
